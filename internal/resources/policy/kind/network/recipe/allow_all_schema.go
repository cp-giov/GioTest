...
func ConstructAllowAll(data []interface{}) (allowAll *policyrecipenetworkmodel.VmwareTanzuManageV1alpha1CommonPolicySpecNetworkV1AllowAll) {
	...
	allowAll = &policyrecipenetworkmodel.VmwareTanzuManageV1alpha1CommonPolicySpecNetworkV1AllowAll{}
...
func FlattenAllowAll(allowAll *policyrecipenetworkmodel.VmwareTanzuManageV1alpha1CommonPolicySpecNetworkV1AllowAll) (data []interface{}) {
	if allowAll == nil {
		return data
	}
